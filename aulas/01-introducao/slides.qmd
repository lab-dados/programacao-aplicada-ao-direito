...
O **Laboratório de Dados e Pesquisa Empírica em Direito** é uma instância da FGV
Direito SP. Ele aproxima a reflexão metodológica em pesquisa empírica, que a
Escola desenvolve há mais de uma década, da ciência de dados e da inteligência
artificial.
...
::: {.cartao}
[**Formação**]{.titulo}
Cursos e oficinas para pesquisadoras e pesquisadores da Escola. Este curso é
parte disso.
:::

::: {.cartao}
[**Pesquisa**]{.titulo}
Projetos empíricos com dados judiciais, em parceria com centros da FGV e de fora
dela.
:::

::: {.cartao}
[**Escritório de apoio**]{.titulo}
Serviços e ferramentas abertas para quem pesquisa: coleta, OCR, transcrição e
estruturação de dados.
:::
:::

::: {.fonte}
Coordenação de **Daniel Wang**. Equipe: **Beatriz Varejão**, **Bruno Oliveira**,
**Helena Funari**, **Julio Trecenti** e **Luiz Pimenta**.
:::
