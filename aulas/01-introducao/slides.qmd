...
:::
::: {.bloco}
[00:10]{.tempo} Por que ainda programar na era da IA
:::
::: {.bloco}
[00:55]{.tempo} Primeiros conceitos: objetos, atributos, métodos e módulos
:::
::: {.bloco}
[01:15]{.tempo} Prática no navegador, todo mundo junto
:::
::: {.bloco}
[01:50]{.tempo} Intervalo
:::
::: {.bloco}
[02:05]{.tempo} Levando o mesmo notebook para o seu computador
:::
::: {.bloco}
[02:45]{.tempo} Fechamento e o que fazer até o próximo encontro
:::
:::
...
::: {.aviso-pratica}
O notebook da aula **já vem dentro** do repositório: é o mesmo que você acabou de
usar no Colab. Os comandos exatos estão no site do curso, prontos para copiar. Só
há **uma pasta**: a sua.
:::
...
:::
::: {.passo}
Abra `aula-01.ipynb`, que já está na pasta.
:::
::: {.passo}
Clique em `Select Kernel` e escolha o `.venv` do projeto.
:::
::: {.passo}
Refaça a Parte C, agora no seu computador.
:::
:::

::: {.centro}
[É o mesmo notebook, o mesmo código e o mesmo resultado. O que mudou é de quem é
a máquina.]{.destaque}
:::
